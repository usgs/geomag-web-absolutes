...
var ObservatoryFactory = function (options) {
   ...
   */
  _getObservatories = function (options) {
   ...
   */
  _getObservation = function (options) {
    options.id = _this.id;
   ...
   */
  _ObservationDetail = Observation(attributes);
   ...
   */
  _ObservationSummary = Observation(attributes);
  ...
  _this.getObservation = function (options) {
    ...
    Xhr.ajax({
      url: _options.observationDetailUrl,
      data: {
        id: options.id
      },
      success: function (data) {
        options.success(_this.getObservation(data));
      },
  ...
  _this.getObservatory = function (options) {
    ...
    Xhr.ajax({
      url: _options.observatoryDetailUrl,
      data: {
        id: options.id
      },
      success: function (data) {
        options.success(_this.getObservatory(data));
      },
      error: options.error || function () {}
    });
  };
  ...
  _this.publishObservation = function (options) {
    var observationPublishUrl = _options.observationPublishUrl,
  ...
  _this.saveObservation = function (options) {
    var observationDetailUrl = _options.observationDetailUrl,
