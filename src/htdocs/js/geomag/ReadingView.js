	...
	ReadingView.prototype._initialize = function () {
		...
		this._el.innerHTML = [
			'<section class="reading-view">',
				'<section class="row">',
					'<h4>Declination</h4>',
					'<section class="column declination-input">',
						'<table>',
							'<thead>',
								'<tr>',
									'<th scope="col">&nbsp;</th>',
						...
						'</table>',
					'</section>',
					'<section class="column declination-output"></section>',
				'</section>',
				'<section class="row">',
					'<h4>Inclination</h4>',
					'<section class="column inclination-input">',
						'<table>',
							'<thead>',
								'<tr>',
									'<th scope="col">&nbsp;</th>',
						...
						'</table>',
					'</section>',
					'<section class="column inclination-output"></section>',
				'</section>',
				'<section >',
