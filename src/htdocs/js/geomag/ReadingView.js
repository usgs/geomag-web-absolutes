  ...
  _initialize = function (options) {
    ...
    _this.el.innerHTML = [
      '<section class="reading-view">',
        ...
        '<div class="row">',
          '<section class="declination-input horizontal-scrolling column">',
            '<table>',
              '<thead>',
                '<tr>',
                  '<th scope="col">&nbsp;</th>',
                  ...
                  '<th scope="col" class="measurement-h">',
                    'H <small>(nT)</small>',
                  '</th>',
                  '<th scope="col" class="measurement-e">',
                    'E <small>(nT)</small>',
                  '</th>',
                  '<th scope="col" class="measurement-z">',
                    'Z <small>(nT)</small>',
                  '</th>',
                  '<th scope="col" class="measurement-f">',
                    'F <small>(nT)</small>',
                  '</th>',
                '</tr>',
              '</thead>',
            ...
            '</table>',
          '</section>',
          '<section class="declination-output column"></section>',
        '</div>',

        '<h2>Inclination</h2>',
        '<div class="row">',
          '<section class="inclination-input horizontal-scrolling column">',
            '<table>',
              '<thead>',
                '<tr>',
                  '<th scope="col">&nbsp;</th>',
            ...
            '</table>',
          '</section>',
          '<section class="inclination-output column"></section>',
        '</div>',
