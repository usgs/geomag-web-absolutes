...
/* add BDT's current instruments - Inst. No., 814503/110/110 */
...
INSERT INTO instrument (observatory_id, serial_number, begin, end, name, type)
VALUES ( @observatory_id, '110', 1000*unix_timestamp('1970-01-01 00:00:00'), NULL, 'Theodolite', 'theo');
...
VALUES ( @observatory_id, 'Main', 1000*unix_timestamp('1970-01-01 00:00:00'), NULL, -23.1, NULL,
         ...
         ( SELECT id FROM instrument WHERE observatory_id=@observatory_id AND serial_number='110' AND begin=1000*unix_timestamp('1970-01-01 00:00:00') )
);
