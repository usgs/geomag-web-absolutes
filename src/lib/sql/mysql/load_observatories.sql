...
VALUES (
  (SELECT id FROM pier WHERE observatory_id=@observatory_id
                         AND name='Main'
                         AND begin = 1000*unix_timestamp('2010-01-01 00:00:00') ),
   'Main Azimuth', 1000*unix_timestamp('1970-01-01 00:00:00'), 1000*unix_timestamp('2011-01-01 00:00:00'), 142.6483
);
INSERT INTO mark (pier_id, name, begin, end, azimuth)
VALUES (
  (SELECT id FROM pier WHERE observatory_id=@observatory_id
                         AND name='Main'
                         AND begin = 1000*unix_timestamp('2010-01-01 00:00:00') ),
   'Main Azimuth', 1000*unix_timestamp('2011-01-01 00:00:00'), 1000*unix_timestamp('2012-10-12 23:19:00'), 142.3217
);
INSERT INTO mark (pier_id, name, begin, end, azimuth)
VALUES (
  (SELECT id FROM pier WHERE observatory_id=@observatory_id
                         AND name='Main'
                         AND begin = 1000*unix_timestamp('2010-01-01 00:00:00') ),
   'Main Azimuth', 1000*unix_timestamp('2012-10-12 23:19:00'), NULL, 142.6483
);
